...
export const TestimonialSection = ({
    ...
    return (
        <section
            className="w-screen relative left-[calc(-50vw+50%)] bg-[#ef4444] pt-32 pb-32 sm:pt-40 sm:pb-40 -mt-16"
            ...
            <div className="container mx-auto max-w-6xl px-4 text-center">
                ...
                >
                    {testimonials.map((testimonial) => (
                        <motion.div
                            key={testimonial.id}
                            className="relative overflow-hidden rounded-lg bg-card shadow-sm border"
